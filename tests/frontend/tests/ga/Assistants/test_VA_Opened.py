...
class TestGA:
    ...
    @qase.title(f"test_va_opened")
    def test_va_opened(self, browser: webdriver.Chrome | webdriver.Edge | webdriver.Firefox, screen_size):
        ...
        with qase.step("1.1 all_va_page, va_sidepanel, card view"):
            ...
            page.click_edit_button_side_panel()

            get_ga_requests(browser, "VA_Opened", page)
