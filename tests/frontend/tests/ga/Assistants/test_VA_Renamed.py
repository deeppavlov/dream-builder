...
class TestGA:
    ...
    @qase.title(f"test_va_renamed")
    def test_va_renamed(self, browser: webdriver.Chrome | webdriver.Edge | webdriver.Firefox, screen_size):
        ...
        with qase.step("1.1. all_va_page card_view"):
            page.click_kebab_your_a()
            page.click_kebab_your_a_rename()

            get_ga_requests(browser, "Rename_VA_Button_Click", page)

            page.clear_name_in_create_va_mw()
            page.enter_name_in_create_va_mw()

            page.click_save_in_edit_va_mw()

            get_ga_requests(browser, "Renamed", page)
        ...
        with qase.step("2.1. yourbots card_view"):
        ...
        with qase.step("2.2. yourbots list_view"):
            page.click_change_view_type_to_list()
        ...
        with qase.step("4. va_action_menu"):
            page.click_main_menu()
            # page.check_main_menu_is_opened()
            page.click_main_menu_rename()
